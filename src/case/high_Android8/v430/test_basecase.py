...
from src.case.high_Android8.bll.v430.index import _close_msg_alert,back_to_index
from src.case.high_Android8.bll.v430.login import *
import time
from utx import *
...
class TestCaseBase(unittest.TestCase):
    ...
    def find_element(self, by="id", value="", timeout=10):
        ...
        try:
            element = WebDriverWait(self.driver, timeout, 0.5).until(lambda x: x.find_element(by=by, value=value))
